...
class HRSiamRPNTracker():
    ...
    def update(self, frame):
        ...
        #返回255x255x3大小的图片、缩放因子是255/(上下文信息x255/127)
        ...
        """----------得到回归参数并对anchor回归————————————"""
        #增加一个batch维度再送入网络，返回score.shape=[1,15,51,19],regression.shape=[1,30,51,51]
